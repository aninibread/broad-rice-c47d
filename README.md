...
With this template, you can deploy your own chat app to converse with other users in real-time. Going to the [demo website](https://broad-rice-c47d.templates.workers.dev) puts you into a unique chat room based on the ID in the url. Share that ID with others to chat with them! This is powered by [Durable Objects](https://developers.cloudflare.com/durable-objects/) and [PartyKit](https://www.partykit.io/).
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-rice-c47d
```

A live public deployment of this template is available at [https://broad-rice-c47d.templates.workers.dev](https://broad-rice-c47d.templates.workers.dev)
